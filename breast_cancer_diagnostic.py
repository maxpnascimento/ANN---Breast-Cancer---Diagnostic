...
Original file is located at
    https://colab.research.google.com/drive/12hD_bSWV4zMTOoW0Ewuwm7QJ2nEzOKyE
...
#Train
X_train = np.array(pd.read_csv("/content/gdrive/MyDrive/Machine Learning/Datasets/Câncer de Mama/xtrain.csv", header=None))
Y_train = np.array(pd.read_csv("/content/gdrive/MyDrive/Machine Learning/Datasets/Câncer de Mama/ytrain.csv", header=None))

#Test
X_test = np.array(pd.read_csv("/content/gdrive/MyDrive/Machine Learning/Datasets/Câncer de Mama/xtest.csv", header=None))
Y_test = np.array(pd.read_csv("/content/gdrive/MyDrive/Machine Learning/Datasets/Câncer de Mama/ytest.csv", header=None))

#Validation
X_validation = np.array(pd.read_csv("/content/gdrive/MyDrive/Machine Learning/Datasets/Câncer de Mama/xvalidation.csv", header=None))
Y_validation = np.array(pd.read_csv("/content/gdrive/MyDrive/Machine Learning/Datasets/Câncer de Mama/yvalidation.csv", header=None))
